...
def main():
    ...
    logger = WandbLogger('BI_DEC_DGM4_BLIP', project="Thesis_New")
    ...
    import json
    with open("esperimenti_aprile_2026/blip_metrics.json", "w") as f:
