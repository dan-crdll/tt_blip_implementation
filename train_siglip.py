...
def main():
    ...
    logger = WandbLogger('BI_DEC_DGM4_SIGLIP', project="Thesis_New")
    ...
    import json
    with open("esperimenti_aprile_2026/siglip_metrics.json", "w") as f:
